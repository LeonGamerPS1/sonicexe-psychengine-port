...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop = [ //Name - Icon name - Description - Link - BG Color
			['Sonic EXE Porters'],
			['Junior',		'shadowmario',		'Main coder of the port',					'https://gamejolt.com/games/Junior-Jonnycats-FNF-Mac-Ports/661502',	'FFDD33'],
			['Jhonnycat',			'riveroaken',		'Second coder of the port',				'https://gamejolt.com/games/Junior-Jonnycats-FNF-Mac-Ports/661502',		'C30085'],
			[''],
			['Psych Engine Team'],
