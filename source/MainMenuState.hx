...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, gameVer +  (Main.watermarks ? " FNF - " + kadeEngineVer + " Kade Engine/Psych Engine v" + psychEngineVersion: ""), 12);
	...
	function goToState()
	{
		...
		{
			case 'story mode':
				FlxG.switchState(new StoryMenuStateCOPY());
